...
<html lang="pt-br">
    ...
    <body>
        ...
        $estado = $_POST['estado'];
        $cep = $_POST['cep'];
        $result = "insert into perfil(senha,email, endereco, endereco2,cidade,estado,cep) values ('$senha', '$email','$endereco','$inputAddress2','$cidade','$estado','$cep')";
        if ($conexao->query($sql) === TRUE) {
            echo "Cadastro realizado com sucesso";
        } else {
            echo "Nao foi possivel realizar o cadastro: " . $sql . "<br>" . $conn->error;
        }
